<?php 
        ...
        if(isset($_POST['search'])){
             ...
             $sql = "Select * from students where t_admission_no='$id_no' ";
             ...
             $html="<div class='card' style='width:350px; padding:0;' >";
               ...
               $html.="";
                         while($row=mysqli_fetch_assoc($result)){
                            ...
                            $name = $row["t_name"];
                            $id_no = $row["t_admission_no"];
                            // $grade = $row['grade'];
                            $dob = $row['t_dob'];
                            $address = $row['t_address'];
                            // $email = $row['t_email'];
                            // $exp_date = $row['exp_date'];
                            $phone = $row['t_phone_number'];
                            $address = $row['t_address'];
                            $image = $row['t_photo'];
                            $date = date('M d, Y', strtotime($row['t_admission_date']));
                             ...
                             $html.="
                                        ...
                                        <div class='container' style='text-align:left; border:2px dotted black;'>
                                              ...
                                              <div class='container-2'>
                                                  <div class='box-1'>
                                                  <img src='images/student_images/$image'/>
                                                  </div>
                                                  <div class='box-2'>
                                                      <h2>$name</h2>
                                                  ...
                                                  <div class='box-3'>
                                                      <img src='images/user_images/Rlogo.jpg' alt=''>
                                                  </div>
                                              </div>
