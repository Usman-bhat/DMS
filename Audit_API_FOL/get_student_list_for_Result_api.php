    ...
    if ($query_run->num_rows > 0) {
        ...
        while ($row = mysqli_fetch_assoc($query_run)) {
           echo ' <tr>
            ...
            <td>'.$row["t_status"].'</td>
            <td>
                <a href="show_result.php?sid='.$row["t_admission_no"] .'" class="btn btn-sm btn-primary" type="submit">
                    <i class="fas fa-eye"></i> Show
                </a>
            </td>
            <td>
                <a href="add_result.php?sid='.$row["t_admission_no"] .'" class="btn btn-sm btn-success">
